...
<?php
      ...
      <!-- <section class="ftco-section mob-ftco-sec secscroll">
        <div class="container">
          ...
          <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <div class="text order-1 text-center" style="padding: 3% 3%;">
              <div class="card" style="width: 20rem; background:rgb(18 18 18 / 60%); border: 2px solid #888; padding: 20px 0;">
                    <img class="card-img-top" src="<?php bloginfo('template_directory'); ?>/assets/homepage/casestudies/Case-Studies-Img-03.svg" width=130 height=130 alt="Card image cap">
                    <div class="card-body text-left">
                      <h5 class="card-title">Metaverse New Beginning</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <div style="display:flex; column-gap: 35%; font-size: 14px;">
                        <a>Feb 2,2022| 02:30 PM</a>
                      <a><img src="<?php bloginfo('template_directory'); ?>/assets/homepage/casestudies/Arrow-Right.svg" width=35 ></a></div>
                    </div>
                  </div>
            </div>
            ...
            <div class="text order-1 text-center" style="padding: 3% 3%;">
              <div class="card" style="width: 20rem; background:rgb(18 18 18 / 60%); border: 2px solid #888; padding: 20px 0;">
                    <img class="card-img-top" src="<?php bloginfo('template_directory'); ?>/assets/homepage/casestudies/Case-Studies-Img-01.svg" width=130 height=130 alt="Card image cap">
                    <div class="card-body text-left">
                      <h5 class="card-title">Metaverse New Beginning</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <div style="display:flex; column-gap: 35%; font-size: 14px;">
            ...
            <div class="text order-1 text-center" style="padding: 3% 3%;">
              <div class="card" style="width: 20rem; background:rgb(18 18 18 / 60%); border: 2px solid #888; padding: 20px 0;">
                    <img class="card-img-top" src="<?php bloginfo('template_directory'); ?>/assets/homepage/casestudies/Case-Studies-Img-02.svg" width=130 height=130 alt="Card image cap">
                    <div class="card-body text-left">
                      <h5 class="card-title">Metaverse New Beginning</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <div style="display:flex; column-gap: 35%; font-size: 14px;">
